...
<div class="thumbnail">
    ...
    <div class="caption-full">
        <h3><a href="#">Inyección XPATH </a></h3>
	...
	produce cuando la aplicación no valida la información proporcionada por el usuario que construye consultas XML. Un atacante puede enviar solicitudes maliciosas a la aplicación
	 para descubrir cómo se estructuran los datos XML y puede aprovechar el ataque para acceder a datos XML no autorizados.      </p><br><br>
        <p>Leer más de inyecciones XPATH<br><br>
...
<h3>Respuesta Back-End:</h3>
    <?php
        if (is_array($result) || is_object($result)){
            ...
            echo "<tr><th>ID</th><th>&nbsp;&nbsp;</th><th>Nombre y Descripción</th></tr>";
